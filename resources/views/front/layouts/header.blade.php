...
<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5" >
        <a class="navbar-brand" href="{{route('homepage')}}">ToDoHomeworkv1</a>
...
<header class="masthead"
        style="background-image: url('@yield('bg',asset('front/img/home-bg.jpg'))'); background-color: #ffffff">
    <div class="container position-relative px-4 px-lg-5e-bg.">
